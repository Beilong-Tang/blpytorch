...
from blpytorch.trainer.helper import dict_to_str, save, load_ckpt
import random
from scheduler.schedulers import PatienceScheduler
...
class AbsTrainer:
    ...
    def _apply_scheduler(self, result):
        if self.new_bob is not None:
            ...
            if isinstance(self.scheduler, PatienceScheduler):
